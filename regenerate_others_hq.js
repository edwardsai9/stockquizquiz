...
async function main() {
  console.log("Submitting 5 high-quality image generation jobs to AI Horde in parallel...");
  const jobs = [];
  ...
  console.log("\nAll 5 high-quality images regenerated and background-removed successfully!");
}
